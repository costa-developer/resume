...
import { SiDribbble, SiLinkedin, SiFacebook, SiInstagram, SiGithub, SiTwitter } from 'react-icons/si';
...
const contactBar = {
  ...
  socialItems: [
    ...
    { platform: "linkedin", icon: "SiLinkedin", link: "..." },
    ...
    { platform: "twitter", icon: "SiTwitter", link: "https://twitter.com/your-profile" }
  ]
};
