...
const contactBar = {
  contactItems: [
    ...
    { type: "phone", label: "+27 61 778 3273", icon: "MdCall", link: "tel:+27617783273" },
  ],
  socialItems: [
    { platform: "linkedin", icon: "SiLinkedin", link: "www.linkedin.com/in/costathedeveloper" },
    { platform: "facebook", icon: "SiFacebook", link: "https://web.facebook.com/tendai.gumunyu.1/" },
    { platform: "instagram", icon: "SiInstagram", link: "https://www.instagram.com/costa_developer/" },
    { platform: "github", icon: "SiGithub", link: "https://github.com/costa-developer" },
  ]
};
...
const contactLinks = {
  socialLinks: [
    {
      title: "Instagram",
      href: "https://www.instagram.com/costa_developer"
    },
    {
      title: "Facebook",
      href: "https://web.facebook.com/tendai.gumunyu.1/"
    },
    {
      title: "Github",
      href: "https://github.com/costa-developer"
    },
    {
      title: "LinkedIn",
      href: "www.linkedin.com/in/costathedeveloper"
    },
    {
      title: "Twitter",
      href: "https://x.com/costadeveloper"
    },
  ],
  contactInfo: [
    {
    ...
    {
      type: "phone",
      label: "+27 61 778 3273",
      link: "tel:+27617783273"
    }
  ]
}
