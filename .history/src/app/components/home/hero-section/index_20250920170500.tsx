            ...
            <div className="container">
                <div className="lg:flex grid grid-cols-1 sm:grid-cols-2 gap-7 md:gap-4 items-center">
                    <div className="flex flex-col gap-4 md:gap-7 max-w-2xl">
                        ...
                        🌐 <strong>Web Developer | JavaScript & PHP | Python & AI/ML</strong><br />
                        🚀 Building smart, scalable web solutions with modern technologies.<br />
                        🤖 Exploring the intersection of code and intelligence through AI & Machine Learning.<br />

                        💻 <strong>Open Source Contributor</strong><br />
                        🔧 Giving back to the developer community and helping build better tools.<br />

                        🌍 <strong>Adventurer & Philosopher</strong><br />
                        🧠 Curious about the world, driven by ideas, always exploring new perspectives.<br />
