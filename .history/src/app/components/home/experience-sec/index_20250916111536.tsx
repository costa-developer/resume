...
const ExperienceSec = () => {
    const experiences = [
        ...
        },
        {
            ...
            type: "Full-time, On-site",
            description: "Managed IT infrastructure to ensure seamless website performance, enhanced security, and system integration. Developed and maintained web applications, focusing on backend systems and optimizing user experience."
        },
        {
            year: "2022 - 2023",
