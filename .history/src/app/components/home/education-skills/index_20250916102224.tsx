                    ...
                    <div className="relative z-10 py-16 md:py-32">
                        ...
                        <div className="flex flex-col lg:flex-row items-center gap-10 xl:gap-20">
                            ...
                            {educationData.skills.map((value, index) => {
                                ...
                                return (
                                    <div key={index} className="p-4 border border-softGray rounded-lg flex flex-col gap-5 items-center justify-between">
                                    <div className="flex flex-col items-center gap-5">
                                        {IconComponent && <IconComponent size={70} />} {/* ✅ Only render if defined */}
