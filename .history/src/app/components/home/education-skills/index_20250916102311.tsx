  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Replace icon URLs with react-icon components
        const skillsWithIcons = data.educationData.skills.map((skill: any) => {
          ...
          return { ...skill, icon: iconMap[skill.name] || SiJavascript };
        });
                  ...
                  return (
                    ...
                    >
                      <div className="flex flex-col items-center gap-5">
                        {IconComponent && <IconComponent size={70} />} {/* Render react-icon */}
